...
/**
 * PartyAuthenticationPasswordEvaluationResponse
 */
public class PartyAuthenticationPasswordEvaluationResponse   {
  ...
  private Object authenticationPasswordEvaluationResult = null;
  ...
  **/
  ...
  /**
   * general-info: Authentication subject can be identification as a customer `status: Provisionally Registered`  bian-reference:  CustomerContactPerson.RepresentedCustomer 
  ...
  **/
  ...
  /**
   * `status: Registered` general-info: Authentication subject can be identified as a party or legal entity bian-reference:  CustomerContactPerson.RepresentedCustomer(asRole).Player(asParty) iso-link: [click-here](https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_EwTfUMTGEeChad0JzLk7QA_-1978180945/elements/_EwTfUcTGEeChad0JzLk7QA_434950303) 
  ...
  **/
  ...
  /**
   * general-info: Refers to reference data item to be compared with submitted value `status: Provisionally Registered`  bian-reference:  (asAuthentication).SubmittedAuthenticationData.AuthenticationDataScheme(asGenericDataScheme).Label 
  ...
  **/
  ...
  /**
   * general-info: Can be customer provided or bank generated value - encryption applies `status: Provisionally Registered`  bian-reference:  CustomerContactPerson(asRole).Player(asPerson).PersonProfile.StoredAuthenticationData(asGenericData).BinaryData  `status: Provisionally Registered`  bian-reference:  CustomerContactPerson(asRole).Player(asPerson).PersonProfile.StoredAuthenticationData(asGenericData).TextualData 
  ...
  **/
  ...
  /**
   * general-info: value returned as a result of the authentication task, defining the level of identity assurance achieved  valid for the duration of the current contact  `status: Provisionally Registered`  bian-reference:  (asAuthentication).AuthenticationLevel  `status: Registered`  bian-reference:  (asAuthentication).AuthenticationResult  iso-link:  [click-here](https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_wcU_wA93EeGeV5vP7Mvdig_-374264443/elements/_UqFPkPkdEea0GN7fTO7hmQ) 
  ...
  **/
   ...
   * @return authenticationPasswordEvaluationResult
  **/

  public Object getAuthenticationPasswordEvaluationResult() {
    return authenticationPasswordEvaluationResult;
  }

  public void setAuthenticationPasswordEvaluationResult(Object authenticationPasswordEvaluationResult) {
    this.authenticationPasswordEvaluationResult = authenticationPasswordEvaluationResult;
  }
